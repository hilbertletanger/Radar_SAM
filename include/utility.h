...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<int>("lio_sam/Radar_target_numbert",Radar_target_number, 2000);
        ...
        nh.param<float>("lio_sam/odometrySurfLeafSize", odometrySurfLeafSize, 0.2); //这里设置featureExtraction中的下采样参数
